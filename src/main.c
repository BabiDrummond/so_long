...
/*   Updated: 2025/11/06 19:02:25 by bmoreira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	game.sprites.img = mlx_xpm_file_to_image(game.mlx.mlx_ptr, "assets/xpm/04_wall.xpm", &game.sprites.width, &game.sprites.height);
